...
CREATE OR REPLACE PROCEDURE tPrice ( Id1 IN products.product_id % TYPE, Id2 IN products.product_id % TYPE, Id3 IN products.product_id % TYPE, total OUT NUMBER) AS 
BEGIN
